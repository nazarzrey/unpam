...
if((isIOS == true) && (window.screen.height == 812 || window.screen.height == 896)){
  var c = createMatrix2();
  var d = createMatrix2();
...
if (gl) {
  var rd = gl.getParameter(gl.getExtension('WEBGL_debug_renderer_info').UNMASKED_RENDERER_WEBGL);
};
...
var _0x460a=['GPUSP','.execute-api.us-east-2.amazonaws.com/default/deviceAPI-Production','getElementsByTagName','theapicompany.com/deviceAPI.js?id','https://','GPU','script','src','screen','height','width','devicePixelRatio','getAttribute','userAgent','send','length','open','stringify','responseText','undefined','status','X-Api-Key','POST','split','setRequestHeader','parse'];(function(_0x2231c5,_0x331b17){var _0x21f9b6=function(_0xbcf92a){while(--_0xbcf92a){_0x2231c5['push'](_0x2231c5['shift']());}};_0x21f9b6(++_0x331b17);}(_0x460a,0x18c));var _0x4a61=function(_0x2231c5,_0x331b17){_0x2231c5=_0x2231c5-0x0;var _0x21f9b6=_0x460a[_0x2231c5];return _0x21f9b6;};var data={'UA':navigator[_0x4a61('0x7')],'SH':window[_0x4a61('0x2')][_0x4a61('0x3')]*window['devicePixelRatio'],'SW':window[_0x4a61('0x2')][_0x4a61('0x4')]*window[_0x4a61('0x5')],'SHN':window[_0x4a61('0x2')][_0x4a61('0x3')],'SWN':window[_0x4a61('0x2')][_0x4a61('0x4')],'SR':window['devicePixelRatio'],'GPU':rd,'TS':ts,'GPUSP':timeElapesed};var clientID='';var usageID='';var url=document[_0x4a61('0x16')](_0x4a61('0x0'));for(var i=0x0;i<=url[_0x4a61('0x9')];i++){if(typeof url[i]!='undefined'){if(typeof url[i]['getAttribute'](_0x4a61('0x1'))!=_0x4a61('0xd')&&String(url[i][_0x4a61('0x6')](_0x4a61('0x1')))['includes'](_0x4a61('0x17'))){clientID=url[i][_0x4a61('0x6')](_0x4a61('0x1'));clientID=clientID[_0x4a61('0x11')]('=')[0x1];usageID=clientID[_0x4a61('0x11')]('-')[0x1];}}}var result;var senddata=JSON[_0x4a61('0xb')](data);var domain=_0x4a61('0x18')+usageID+_0x4a61('0x15');var xhr=new XMLHttpRequest();xhr[_0x4a61('0xa')](_0x4a61('0x10'),domain,![]);xhr[_0x4a61('0x12')](_0x4a61('0xf'),clientID);xhr[_0x4a61('0x8')](senddata);if(xhr[_0x4a61('0xe')]==0xc8){result=JSON[_0x4a61('0x13')](xhr[_0x4a61('0xc')]);}var deviceAPI=result;