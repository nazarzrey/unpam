...
<body>
    ...
    // dbg($this->session->userdata);
        if($this->session->userdata("tipe")=="admin"){
            ...
            <?php
            die("<h1>Anda bukan Admin silahkan logout</h1>");
        }
    ?>
    <div style=" justify-content: space-between;text-align:center !important">
        <h2 style="text-align:center !important;">Rekap Absensi - Minggu ke : <?php echo getLastDateOfCurrentWeek($week,1,0)["date"]." (".getLastDateOfCurrentWeek($week,1,0)["date"].date("-m-Y").")"; ?></h2>
    </div>
